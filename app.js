...
const companyRows = [
  ...
  { rank: 13, name: "伯克希尔", value: 10372.30932, logoSrc: "./assets/company-logos/berkshire.png" },
...
function renderGdp() {
  ...
  return `
    <section class="gdp-cinema" style="--gdp-1000-x:${milestone1000X}px;--gdp-5000-x:${milestone5000X}px;--gdp-8000-x:${milestone8000X}px;--gdp-top30-x:${topThirtyX}px;--gdp-pause-x:${pauseX}px;--gdp-end-x:${endX}px;--gdp-duration:20s" aria-label="国家GDP像素分镜">
      ...
      <div class="gdp-bubble">
        <p><span>马斯克身家</span><em>1万亿</em></p>
        <p><span>超越</span><strong>197</strong><span>个经济体的GDP</span></p>
      </div>
    </section>
...
function showCompanyTip(target, message) {
  ...
  const left = Math.max(10, Math.min(targetRect.left - cinemaRect.left + targetRect.width / 2, cinemaRect.width - 10));
